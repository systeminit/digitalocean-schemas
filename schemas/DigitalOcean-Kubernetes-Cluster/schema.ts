function main() {
    ...
    const versionProp = new PropBuilder()
        ...
        .setWidget(new PropWidgetDefinitionBuilder()
            .setKind("comboBox")
            .addOption("Kubernetes 1.31.1-do.4", "1.31.1-do.4")
            .addOption("Kubernetes 1.30.5-do.0", "1.30.5-do.0")
            .addOption("Kubernetes 1.29.9-do.0", "1.29.9-do.0")
            .addOption("Kubernetes 1.28.14-do.0", "1.28.14-do.0")
